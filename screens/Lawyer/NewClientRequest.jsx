...
const NewClientRequest = ({navigation}) => {
  ...
  const renderClientCard = (client) => (
    <TouchableOpacity key={client.id} style={styles.clientCard}  onPress={() => navigation.navigate('ClientCaseDetail')}>
      <View style={styles.cardContent}>
        ...
        <View style={styles.clientInfoContainer}>
          ...
          <Text style={styles.caseDetails}>{`Case No: ${client.caseNo}\nCase Charges: ${client.caseCharges}`}</Text>
        </View>
      </View>
    </TouchableOpacity>
  );
